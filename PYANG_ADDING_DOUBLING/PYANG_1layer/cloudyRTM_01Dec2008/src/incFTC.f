...
C
       ...
       CHARACTER*40 VCLOUD  ! cloud coefficient version
C      version template    '#.## YY-MM-DD <--------comment--------->'
       PARAMETER( VSARTA = '1.08 08-11-25 PCLSAM slabcloud HG3')
       PARAMETER( VSCOEF = '08-04-30 Apr08 m130x CO2=370' )
       PARAMETER( VCLOUD = '08-06-13 m140')
