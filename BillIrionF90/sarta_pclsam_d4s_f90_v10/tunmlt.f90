...
!    TUNMLT ( IOUN, NCHAN, INDCHN, SETCHN,
...
! 20 Sep 2017 Bill Irion     Conversion to F90
...
!         Check that ICHAN agrees with I
 ...
 1040        FORMAT('Error reading tuning multipler file: Expected channel ID ',I4,' but file has ID ',I4)
             STOP
          ENDIF
!
!         Update USEMLT
...
!
 ...
 910   CLOSE(IOUN)
	...
	!write(6,*) 'usemlt(fixed,H2Oline,H2Ocon,O3,CO,CH4,NTE)=', (USEMLT(J),J=1,7)
