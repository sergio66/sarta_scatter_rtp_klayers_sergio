...
MODULE CALT6
	...
	REAL, PRIVATE, DIMENSION(:, :), ALLOCATABLE :: DKN2O_SAVED
 	...
 	LOGICAL :: CALT6_ALLOCATED

CONTAINS

	SUBROUTINE CALT6__ALLOCATE(NCHN6)
		...
		CALT6_ALLOCATED = .TRUE.

		PRINT *, "CALT6 allocated"	

	END SUBROUTINE CALT6__ALLOCATE


	SUBROUTINE CALT6__CALCULATE_OD ( INDCHN, NLAY, NCHN6, CLIST6, &
	...
	END SUBROUTINE CALT6__CALCULATE_OD
