...
MODULE CALT4
	...
	LOGICAL :: CALT4_ALLOCATED

CONTAINS

	SUBROUTINE CALT4__ALLOCATE(NCHN4)
		...
		CALT4_ALLOCATED = .TRUE.
	
		PRINT *, "CALT4 allocated"	

	END SUBROUTINE CALT4__ALLOCATE


	SUBROUTINE CALT4__CALCULATE_OD ( INDCHN, NLAY, NCHN4, CLIST4, &
...
!-----------------------------------------------------------------------
	...
	END SUBROUTINE CALT4__CALCULATE_OD
