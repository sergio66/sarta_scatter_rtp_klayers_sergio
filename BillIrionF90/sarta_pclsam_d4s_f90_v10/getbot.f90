...
!    11 Jan 2017 Bill Irion 	Conversion to module. Saves value and
!                               returns saved values by different subroutine.


MODULE GETBOT

	INTEGER, PRIVATE :: LBOT_SAVED
	REAL, PRIVATE :: BLMULT_SAVED

CONTAINS

	SUBROUTINE GETBOT__GETBOT ( NLAY, PLEV, PSURF, LBOT, BLMULT )
	...
	END SUBROUTINE GETBOT__GETBOT

	SUBROUTINE GETBOT__GET_SAVED_GETBOT(LBOT, BLMULT)
	...
	END SUBROUTINE GETBOT__GET_SAVED_GETBOT
