...
MODULE CALT7
	...
	REAL, PRIVATE, DIMENSION(:, :), ALLOCATABLE :: DKN2O_SAVED
 	...
 	LOGICAL :: CALT7_ALLOCATED

CONTAINS

	SUBROUTINE CALT7__ALLOCATE(NCHN7)
		...
		PRINT *, "CALT7 allocated"

		CALT7_ALLOCATED = .TRUE.

	END SUBROUTINE CALT7__ALLOCATE


	SUBROUTINE CALT7__CALCULATE_OD ( &
	...
	END SUBROUTINE CALT7__CALCULATE_OD
