...
!    AIRS
!
!    CALT5_SOLAR (set5=FWO sun bfsw) version with trace gases (no SO2 or HNO3)
!
!F77====================================================================
...
!CALL PROTOCOL:
!    CALT5_SOLAR( INDCHN, NLAY, NCHN5, CLIST5, COEF5,
...
MODULE CALT5_SOLAR
		...
		LOGICAL :: CALT5_SOLAR_ALLOCATED

CONTAINS

	SUBROUTINE CALT5_SOLAR__ALLOCATE(NCHN5)
		...
		CALT5_SOLAR_ALLOCATED = .TRUE.

		PRINT *, "CALT5_SOLAR allocated"	

	END SUBROUTINE CALT5_SOLAR__ALLOCATE

	SUBROUTINE CALT5_SOLAR__CALCULATE_OD ( &
...
!
       RETURN
       END SUBROUTINE CALT5_SOLAR__CALCULATE_OD

END MODULE CALT5_SOLAR
