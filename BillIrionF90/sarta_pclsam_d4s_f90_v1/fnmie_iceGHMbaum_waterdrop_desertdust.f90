...
!      =================================================================
       SUBROUTINE FNMIE2 ( VCLOUD, MIETYP, FNMIEA, FNMIEE, FNMIEG )
...
!                 <------------cloud string------------->
       ...
       MIETYP(1)=201
       FNMIEA(1)='SCATTERDATABASE/ice_baumGHM_abs.dat'
       FNMIEE(1)='SCATTERDATABASE/ice_baumGHM_ext.dat'
       FNMIEG(1)='SCATTERDATABASE/ice_baumGHM_asy.dat'
!
...
!                 <------------cloud string------------->
       ...
       MIETYP(2)=101
       FNMIEA(2)='SCATTERDATABASE/waterdrop_abs.dat'
       FNMIEE(2)='SCATTERDATABASE/waterdrop_ext.dat'
       FNMIEG(2)='SCATTERDATABASE/waterdrop_asy.dat'
!
...
!                 <------------cloud string------------->
       ...
       MIETYP(3)=301
       FNMIEA(3)='SCATTERDATABASE/desertdust_abs.dat'
       FNMIEE(3)='SCATTERDATABASE/desertdust_ext.dat'
       FNMIEG(3)='SCATTERDATABASE/desertdust_asy.dat'
!
