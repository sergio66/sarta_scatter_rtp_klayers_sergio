 ...
 */
#define VERSION "RTP version 2.01, 24 Oct 08"
...
#define PFIELDSMAX  5   /* max value of pfields (1+4) 		*/
...
struct rtp_prof {
  ...
  /* radiance orientation data (7 fields) */
