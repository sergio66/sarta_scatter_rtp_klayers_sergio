...
C 22 Aug 2007 Scott Hannon      Added code number 55 {microns}
...
C      Currently only the following are allowed: (see toppmv.f)
       DATA GUCS( 1) / 10 /   ! dry air PPMV (parts per million volume)
       DATA GUCS( 2) / 11 /   ! dry air PPBV (parts per billion volume)
       DATA GUCS( 3) / 12 /   ! dry air volume mixing ratio (fraction)
       DATA GUCS( 4) / 15 /   ! wet air PPMV (parts per million volume)
       DATA GUCS( 5) / 16 /   ! wet air PPBV (parts per billion volume)
       DATA GUCS( 6) / 17 /   ! wet air volume mixing ratio (fraction)
       DATA GUCS( 7) / 20 /   ! dry air mass mixing ratio in g/kg 
       DATA GUCS( 8) / 21 /   ! dry air mass mixing ratio in g/g 
       DATA GUCS( 9) / 25 /   ! wet air mass mixing ratio in g/kg 
       DATA GUCS(10) / 26 /   ! wet air mass mixing ratio in g/g 
       DATA GUCS(11) / 30 /   ! partial pressure in millibars or hPa
       DATA GUCS(12) / 31 /   ! partial pressure in atm
       DATA GUCS(13) / 40 /   ! relative humidity in percent
       DATA GUCS(14) / 41 /   ! relative humidity (fraction)
C
ccc
