...
C    17 Dec 2004 Scott Hannon   Add PTYPE to RDRTP call; add NLAY to
C                                  GETBOT call.
C    19 Aug 2005 Scott Hannon   MODIS version; new RDCOEF & CALPAR vars
C    23 Aug 2005 Scott Hannon   Add surface COEFNU
...
C      for RDCOEF             ! Info for selected channels only
       ...
       REAL COEFNU(NCOFNU,MAXLAY+1,MXCHAN) ! chan freq coefs
C
C      for rtpopen
       INTEGER rtpopen
       CHARACTER*1 MODE
