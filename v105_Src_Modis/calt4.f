...
C       FIXMUL, CONPD4, FPRED4, CPRED4, OPRED4, WPRED4, CO2PRD, INDCO2,
C       COFCO2, CO2MLT, XZ, TAU, TAUZ )
...
C      =================================================================
     ...
     $    COEF4, FIXMUL, CONPD4, FPRED4, CPRED4, OPRED4, WPRED4, CO2PRD,
     $    INDCO2, COFCO2, CO2MLT, XZ, TAU, TAUZ )
C      =================================================================
...
C            Calc total layer optical depth
             KLAYER=KCON + KFIX + KCO + KOZO + KWAT + DKCO2
C
