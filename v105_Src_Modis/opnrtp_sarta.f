...
C       IH2O, IO3, ICO, ICH4, IOPCI, HEAD, HATT, PATT)
...
C      =================================================================
     ...
     $    INDCHN, IH2O, IO3, ICO, ICH4, IOPCI, HEAD, HATT, PATT)
C      =================================================================
...
C      -------------------------------------------
C      Detemine indices of gases required by sarta
C      -------------------------------------------
       IH2O=-1
       IO3 =-1
       ICO =-1
...
C      Loop over gases
       DO I=1,NGASI
          IF (GLISTI(I) .EQ. 1) IH2O=I
          IF (GLISTI(I) .EQ. 3) IO3=I
          IF (GLISTI(I) .EQ. 5) ICO=I
          IF (GLISTI(I) .EQ. 6) ICH4=I
       ENDDO
       IF (IH2O .LT. 1) THEN
       ...
       ELSEIF (ICH4 .LT. 1) THEN
          ...
          STOP
       ENDIF
 1030  FORMAT('Error! input files does not contain gas ',I1,' = ',A3)
C
