...
C    REAL arr  MAMNT   methane amount              k.mol/cm2
C    REAL arr  OAMNT   ozone amount                k.mol/cm2
...
C       "F"  is the "fixed" gases amount (we use the CO2 amount)
C       "W"  is the water amount
C       "O"  is the ozone amount
C       "C"  is the carbon monoxide amount
C       "M"  is the methane amount
C    ===================================================================
