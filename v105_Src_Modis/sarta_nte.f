...
!DESCRIPTION:
C    March 2005 version of the SARTA (Stand-Alone Radiative
C    Transfer Algorith) by L.L.Strow, S.Hannon, and H.Mottler
C
...
C                                  call.
C    15 Mar 2005 Scott Hannon   Add non-LTE
...
C      for non-LTE
       ...
       INTEGER CLISTN(MXCHNN)            ! non-LTE channel list
       REAL  COEFN(NNCOEF,MXCHNN)        ! non-LTE coefficients
C
C      for rtpopen
       INTEGER rtpopen
       CHARACTER*1 MODE
...
C      Other variables for the sun
       ...
       REAL SUNCOS         ! cosine of sun zenith angle at surface
...
C      ------------------------
     ...
     $   WAVGOP, COFH2O, FX, NCHNTE, CLISTN, COEFN )
C
