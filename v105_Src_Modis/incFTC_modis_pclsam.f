...
C Cloud filenames
       CHARACTER*80 F1MIEA ! mie absorption data filename
       CHARACTER*80 F1MIEE ! mie extinction data filename
       CHARACTER*80 F1MIEG ! mie asymmetry ("g") data filename
       CHARACTER*80 F2MIEA ! mie absorption data filename
       CHARACTER*80 F2MIEE ! mie extinction data filename
       CHARACTER*80 F2MIEG ! mie asymmetry ("g") data filename
C
C      top cloud(1): dust
       PARAMETER(F1MIEA=
     & '/home/sergio/MATLABCODE/JIGOU/DATA/desert_small_log2_abs.dat')
       PARAMETER(F1MIEE=
     & '/home/sergio/MATLABCODE/JIGOU/DATA/desert_small_log2_ext.dat')
       PARAMETER(F1MIEG=
     & '/home/sergio/MATLABCODE/JIGOU/DATA/desert_small_log2_asy.dat')
C
C      bottom cloud(2): dust
       PARAMETER(F2MIEA=
     & '/home/sergio/MATLABCODE/JIGOU/DATA/desert_small_log2_abs.dat')
       PARAMETER(F2MIEE=
     & '/home/sergio/MATLABCODE/JIGOU/DATA/desert_small_log2_ext.dat')
