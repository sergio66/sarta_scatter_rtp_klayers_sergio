...
!CALL PROTOCOL:
C    CALPAR ( LBOT, RTEMP,  RFAMNT, RWAMNT, ROAMNT, RCAMNT, RMAMNT,
C  $                PTEMP,  PFAMNT, PWAMNT, POAMNT, PCAMNT, PMAMNT,
...
C    REAL arr  PFAMNT  profile fixed gases amount  kiloMoles/cm^2
...
C    REAL arr  RFAMNT  reference fixed amount      kiloMoles/cm^2
...
C      =================================================================
     ...
     $    PTEMP,  PFAMNT, PWAMNT, POAMNT, PCAMNT, PMAMNT,
...
C
C         ---------------
C         CO2 perturbation coefs
C         ---------------
          CO2PRD(1,L)=SECANG(L)
          CO2PRD(2,L)=TR
          CO2PRD(3,L)=SECANG(L)*TR
          CO2PRD(4,L)=SECANG(L)*TJUNKS
C
       ENDDO
