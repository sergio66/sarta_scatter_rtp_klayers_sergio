...
rtpdumper = ['! /home/sergio/git/rtp/rtpV221_150levs/utils/rtpdump -p -n 1 /home/sergio/SARTA_CLOUDY_RTP_KLAYERS_NLEVELS/KLAYERS_RTPv221_150levs_120km/klayersV205_0_120km/Test_rtpV221/pin_feb2002_raw_ip.rtp >& ugh'];
eval(rtpdumper)
...
semilogy(p080.ptemp(:,1),p080.plevs(:,1),p120.ptemp(:,1),p120.plevs(:,1),'linewidth',2); set(gca,'ydir','reverse'); xlim([170 320]); ylim([2e-5 1013])
