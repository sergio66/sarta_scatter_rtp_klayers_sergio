...
C      -----------------------------------------------------------------
c       CHARACTER*90 DFAFGL  ! Default file for AFGL models
       CHARACTER*132 DFAFGL  ! Default file for AFGL models
C
       PARAMETER(DFAFGL=
ccc     $ '../Data/glatm.dat')
ccc     $ '/asl/packages/klayersV205/Data/glatm_9July2010.dat')
c     $ '/asl/packages/klayersV205/Data/glatm.dat')
     $'/home/sergio/git/SARTA_CLOUDY_RTP_KLAYERS_NLEVELS/
     $KLAYERS_RTPv221_150levs_80km/klayersV205_0_80km/Data/glatm.dat')
