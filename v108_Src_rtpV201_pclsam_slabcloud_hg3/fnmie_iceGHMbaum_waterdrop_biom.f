...
c originally in /asl/data/sarta_database/Data_mie_apr08/
c now in /asl/rta/sarta_database/Data_mie_apr08/
...
C      mie particles #3: biomass
C                 <------------cloud string------------->
       CLDSTR(3)='301=biomass 2020-02-20'
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/asl/s1/sergio/AIRS2834CHANS_MIE/biom_log2_abs.dat'
       FNMIEE(3)=
     $ '/asl/s1/sergio/AIRS2834CHANS_MIE/biom_log2_ext.dat'
       FNMIEG(3)=
     $ '/asl/s1/sergio/AIRS2834CHANS_MIE/biom_log2_asy.dat'
C
