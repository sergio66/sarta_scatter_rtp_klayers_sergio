...
c MOVE /asl/data/sarta_database/Data_mie_apr08/ to
c      /asl/s1/sergio/data/sarta_scatter_database/SCATTERDATABASE/
c which is symbolicly linked to /home/sergio/sarta_scatter_ln
...
C                 <------------cloud string------------->
       ...
       MIETYP(1)=201
       FNMIEA(1)=
     $ '/home/sergio/sarta_scatter_ln/ice_baumGHM_abs.dat'
       FNMIEE(1)=
     $ '/home/sergio/sarta_scatter_ln/ice_baumGHM_ext.dat'
       FNMIEG(1)=
     $ '/home/sergio/sarta_scatter_ln/ice_baumGHM_asy.dat'
C
...
C                 <------------cloud string------------->
       ...
       MIETYP(2)=101
       FNMIEA(2)=
     $ '/home/sergio/sarta_scatter_ln/waterdrop_abs.dat'
       FNMIEE(2)=
     $ '/home/sergio/sarta_scatter_ln/waterdrop_ext.dat'
       FNMIEG(2)=
     $ '/home/sergio/sarta_scatter_ln/waterdrop_asy.dat'
C
...
C                 <------------cloud string------------->
       ...
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/home/sergio/sarta_scatter_ln/desertdust_abs.dat'
       FNMIEE(3)=
     $ '/home/sergio/sarta_scatter_ln/desertdust_ext.dat'
       FNMIEG(3)=
     $ '/home/sergio/sarta_scatter_ln/desertdust_asy.dat'
C
