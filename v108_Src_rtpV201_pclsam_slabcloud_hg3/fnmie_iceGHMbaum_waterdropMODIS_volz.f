...
C      mie particles #2: water drop with MODIS variance
C                 <------------cloud string------------->
       CLDSTR(2)='101=waterdrop 2013-09-13'
       MIETYP(2)=101
       FNMIEA(2)=
     $ '/asl/data/sarta_database/Data_mie_apr08/water_modisVEFF_abs.dat'
       FNMIEE(2)=
     $ '/asl/data/sarta_database/Data_mie_apr08/water_modisVEFF_ext.dat'
       FNMIEG(2)=
     $ '/asl/data/sarta_database/Data_mie_apr08/water_modisVEFF_asy.dat'
C

C      mie particles #3: desert dust
c see /home/sergio/CLOUDS_MIEDATA/ORIG_CODE/MAKE_SARTA_MIE_JIGOU/input_output2834.m
C                 <------------cloud string------------->
       CLDSTR(3)='301=desertdust 2020-08-21'
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/asl/rta/sarta_database/Data_mie_apr08/volz_small_0507_log2_abs.dat'
c     $ '/asl/rta/sarta_database/Data_mie_apr08/volz_1_0507_log2_abs.dat'
       FNMIEE(3)=
     $ '/asl/rta/sarta_database/Data_mie_apr08/volz_small_0507_log2_ext.dat'
c     $ '/asl/rta/sarta_database/Data_mie_apr08/volz_1_0507_log2_ext.dat'
       FNMIEG(3)=
     $ '/asl/rta/sarta_database/Data_mie_apr08/volz_small_0507_log2_asy.dat'
c     $ '/asl/rta/sarta_database/Data_mie_apr08/volz_1_0507_log2_asy.dat'
