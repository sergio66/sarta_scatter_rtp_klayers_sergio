...
C
C change /asl/data/sarta_database/Data_AIRS_apr08/Coef/ to
c        /home/strow/asl/data/sarta_database/Data_AIRS_apr08/Coef/
c originally in /asl/data/sarta_database/Data_AIRS_apr08/Coef/
c now in /asl/rta/sarta_database/Data_AIRS_apr08/Coef/
       PARAMETER(FNCOF1=
     $ '/home/strow/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set1_XCSNAMEX.dat')
       PARAMETER(FNCOF2=
     $ '/home/strow/asl/data/sarta_database/Data_AIRS_apr08/Coef/'
     $ // 'set2_XCSNAMEX.dat')
...
cC     $ // 'profref_trace385')
cC      refprof N2O scaled by 1/1.04 for tuning purposes
c     $ // 'profref_trace385tuned')
     $ '/asl/rta/sarta_database/Data_AIRS_apr08/Coef/'
cC     $ // 'profref_trace385')
cC      refprof N2O scaled by 1/1.04 for tuning purposes
     $ // 'profref_trace385tuned')
       PARAMETER(FNSUN =
     $ '/home/strow/asl/data/sarta_database/Data_AIRS_apr08/Solar/'
     $ // 'solar_XCSNAMEX.txt')
C
