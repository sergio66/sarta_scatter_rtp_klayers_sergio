...
C
C      for RDINFO
c sergio : Scott had 80 chars, I have set to 120
...
c             print *,NCHAN,LBOT,INDMI2,MIENPS,CNGWA2,
c     $               CPSIZ2, CPRTO2, CPRBO2,
c     $	             G_ASY2(1291),NEXTO2(1291),NSCAO2(1291)
c            print *,'ABC=',LCBOT2, LCTOP2,CLRB2, CLRT2, TCBOT2, TCTOP2,
c     $        MASEC2,MASUN2     
...
C          print *,LBLAC1,RADC1,CFRA1X
C          print *,FREQ(I),RPLNCK(LBOT),RSURFE,RAD0,RADC1,RADC2,RADC12,
C     $         FCLEAR,CFRA1X,CFRA2X,CFRA12


ccc this block for testing
c       if (I .EQ. 1291) then
cc         print *,'chan1291 rad0,radc1,radc2,radc12,FINAL=',
cc    $      RAD0,RADC1,RADC2,RADC12,RAD(I)
