...
C      mie particles #3: basalt
C                 <------------cloud string------------->
       CLDSTR(3)='301=basalt 2008-06-13'
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/basalt_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/basalt_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/basalt_asy.dat'
C
