...
C                 <------------cloud string------------->
       ...
       MIETYP(2)=101
       FNMIEA(2)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/waterdrop_abs.dat'
       FNMIEE(2)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/waterdrop_ext.dat'
       FNMIEG(2)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/waterdrop_asy.dat'
C
