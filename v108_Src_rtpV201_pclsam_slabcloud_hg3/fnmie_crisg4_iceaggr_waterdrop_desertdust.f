...
C                 <------------cloud string------------->
       ...
       MIETYP(1)=201
       FNMIEA(1)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/ice_aggr_abs.dat'
       FNMIEE(1)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/ice_aggr_ext.dat'
       FNMIEG(1)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/ice_aggr_asy.dat'
C
