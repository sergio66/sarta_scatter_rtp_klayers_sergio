...
C      mie particles #1: Bryan Baum ice aggregates
C                 123456789012345678901234567890123456789
C                 <------------cloud string------------->
       CLDSTR(1)='201=ice_aggr 2012-02-12 Baran'
       MIETYP(1)=201
       FNMIEA(1)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/ice_baumGHM_abs.dat'
       FNMIEE(1)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/ice_baumGHM_ext.dat'
       FNMIEG(1)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/ice_baumGHM_asy.dat'
C

C      mie particles #2: modis water drop
C                 <------------cloud string------------->
       CLDSTR(2)='101=waterdrop 2012-02-12'
       MIETYP(2)=101
       FNMIEA(2)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/modiswaterdrop_abs.dat'
       FNMIEE(2)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/modiswaterdrop_ext.dat'
       FNMIEG(2)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/modiswaterdrop_asy.dat'
C

C      mie particles #3: desert dust
C                 <------------cloud string------------->
       CLDSTR(3)='301=desertdust 2012-02-12'
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/desertdust_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/desertdust_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_CrISg4/desertdust_asy.dat'
C
