...
C                 <------------cloud string------------->
       CLDSTR(3)='211=cirrus 2008-01-31'
       MIETYP(3)=211
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/cirrus_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/cirrus_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/cirrus_asy.dat'
C
