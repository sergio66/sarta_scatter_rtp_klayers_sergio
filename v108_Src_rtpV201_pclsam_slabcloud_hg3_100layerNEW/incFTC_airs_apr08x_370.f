...
C 15 Aug 2013 Sergio Machado Re-Add IDCLD1, IDCLD2, CNGMIN, CFRMIN
...
C      version template    '#.## YYYY-MM-DD <--------comment------->'
       ...
       PARAMETER( VSCOEF = 'AIRS 2008-04-30 XCSNAMEX CO2=370' )
...
c       PARAMETER( CO2STD = 385.0 )  ! m130, m140, m150
C
...
C      Cloud ID numbers (ie what to look for in HEAD.glist)
       ...
       INTEGER IDCLD3 ! aerosol number
       PARAMETER( IDCLD1 = 201 )
       PARAMETER( IDCLD2 = 202 )
       PARAMETER( IDCLD3 = 203 )
C
C      Cloud minimums
