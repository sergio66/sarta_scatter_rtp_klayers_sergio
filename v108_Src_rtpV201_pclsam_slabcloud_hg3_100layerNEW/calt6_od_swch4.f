...
C       INDN2O, COFN2O, N2OMLT, INDCH4, COFCH4, CH4MLT,
C       TAU, TAUZ )
...
!DESCRIPTION:
C    May 2009 version of the 100 layer IASI Fast Transmittance
...
C 13 Apr 2010 Scott Hannon   Modified for pclsam_slabcloud variant
