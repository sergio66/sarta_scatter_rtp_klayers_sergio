...
cc          print *,'rdcldt',FNMIEA(K)
cc          print *,MIENPS(K),(MIEPS(IL,K),IL=1,MIENPS(K))
cc          print *,' '
cc uncomment for testing
...
cc uncomment for testing
c          print *,MIEPS(IL,1),IL=1,MIENPS(1))
c          print *,' '
c          print *,(MIEABS(IL,1,1),IL=1,4)
c          print *,' '
c          print *,(MIEEXT(IL,1,1),IL=1,4)
c          print *,' '
c          print *,(MIEASY(IL,1,1),IL=1,4)
c          stop
