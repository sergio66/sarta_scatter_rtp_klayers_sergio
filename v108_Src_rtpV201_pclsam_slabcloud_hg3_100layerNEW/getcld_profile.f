...
C
!F77====================================================================
c  copied from /home/sergio/SARTA_CLOUDY/v107_Src_pclsam_ctype_100layer_rtpV201/SAFECOPY/getcld.f
!F77====================================================================
...
C      =================================================================
       SUBROUTINE GETCLD_PROFILE( IPROF, ICLD1, ICLD2, HEAD, PROF,
...
C               Prof is in bottom-up order
             ...
             ENDIF
          ENDIF
       ELSEIF ((CTYPE1 .LT. 100) .AND. (PROF.cprtop .GT. 0)) THEN
...
C               Prof is in bottom-up order
       ...
       ELSEIF ((CTYPE2 .LT. 100) .AND. (PROF.cprtop2 .GT. 0)) THEN
C         Black cloud; load cloudtop surface
          LBLAC2=.TRUE.
          CPRTO2=PROF.cprtop2
c          CEMIS2=PROF.udef(18)
          CEMIS2=1
       ENDIF
C
...
C      Both clouds fraction
       ...
       IF (CFRA12 .GT. 1.0) THEN
          IF (CFRA12 .LT. 1.0002) THEN
             CFRA12=1.0
          ELSE
             WRITE(IOERR,1030) IPROF,(CFRA12-1.0)*1e15
 1030        FORMAT('Error, prof=',I6,': cfra12 > 1.0 by ',F10.6)
             STOP
          ENDIF
       ENDIF
C
       ...
       IF (CFRA12 .GT. CFRAC1) THEN
          IF (CFRA12/CFRAC1 .LT. 1.0002) THEN
             CFRA12=CFRAC1
          ELSE
...
C      Compute exclusive cloud fractions
       ...
       IF (CFRA1X .LT. 0) THEN
          WRITE(IOERR,1045) IPROF,CFRA1X
 1045     FORMAT('Error, iprof=',I5,' has xclusive CFRA1X=',F10.6)
          STOP
       ENDIF

       IF (CFRA2X .LT. 0) THEN
          WRITE(IOERR,1046) IPROF,CFRA2X
 1046     FORMAT('Error, iprof=',I5,' has xclusive CFRA2X=',F10.6)
          STOP
       ENDIF
...
c       print *,CTYPE1,CTYPE2
c       print *,CFRAC1,CFRAC2
c       print *,LBLAC1,LBLAC2
ccc
C
