...
C 15 Aug 2013 S.Machado      Add IDCLD1, IDCLD2, CNGMIN, CFRMIN
c 07 Jan 2015 S.Machado      Add IDCLD3
...
C***********************************************************************
C***********************************************************************
C      Cloud related info

C      Mie lookup tables; also see "fnmie.f"
c       INTEGER MXMIEA  ! max # of mie particle sizes
c       INTEGER NMIETY  ! number of mie particle types
c       PARAMETER(MXMIEA = 10) ! ice aggregates=8, all others 10
c       PARAMETER(NMIETY = 3)

C
C      Cloud ID numbers (ie what to look for in HEAD.glist)
c       INTEGER IDCLD1 ! cloud1 ID number
c       INTEGER IDCLD2 ! cloud2 ID number
c       INTEGER IDCLD3 ! aerosol ID number
c       PARAMETER( IDCLD1 = 201 )
c       PARAMETER( IDCLD2 = 202 )
c       PARAMETER( IDCLD3 = 203 )
C
C      Cloud minimums
c       REAL CNGMIN    ! min cngwat to consider (g/m^2)
c       REAL CFRMIN    ! min cloud fraction to consider
c       PARAMETER( CNGMIN = 1E-6 )
c       PARAMETER( CFRMIN = 1E-4 )
C
