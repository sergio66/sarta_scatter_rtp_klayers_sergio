...
C       COEFF, CNGWAT, NEXTB, NSCAB, G_ASYM, xNEXTB, xNSCAB, xG_ASYM,
C       LTOPC, LBOTC, RAD1 )
...
C    REAL matr xNEXTB   cloud extinction            per g/m^2
C    REAL matr  xNSCAB   cloud1scattering            per g/m^2
C    REAL matr  xG_ASYM  cloud asymmetry parameter   none
...
C      =================================================================
     ...
     $    TRANS, RHOSUN, RHOTHR, COEFF, CNGWAT, 
     $    NEXTB, NSCAB, G_ASYM, xNEXTB, xNSCAB, xG_ASYM,
     $    LTOPC, LBOTC, RAD1 )
C      =================================================================
...
C      Cloud info
       ...
       REAL xG_ASYM(MAXLAY,MXCHAN)    ! "g" asymmetry  with lay
       REAL xNEXTB(MAXLAY,MXCHAN)    ! nadir extinction with lay
       REAL xNSCAB(MAXLAY,MXCHAN)    ! nadir scattering with lay
...
C
             NEXTOD=xNEXTB(L,I)*CNGWAT(L)
             NSCAOD=xNSCAB(L,I)*CNGWAT(L)
             GL(L)=xG_ASYM(L,I)
C
