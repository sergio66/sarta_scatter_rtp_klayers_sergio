...
C      mie particles #3: cirrus (spherical 0.1 to 100 um)
C                 <------------cloud string------------->
       CLDSTR(3)='211=cirrus 2008-06-13'
       MIETYP(3)=211
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/cirrus_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/cirrus_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/cirrus_asy.dat'
C
