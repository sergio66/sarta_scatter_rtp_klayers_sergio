...
C                 <------------cloud string------------->
       CLDSTR(3)='301=andesite 2008-01-31'
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/andesite_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/andesite_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/andesite_asy.dat'
C
