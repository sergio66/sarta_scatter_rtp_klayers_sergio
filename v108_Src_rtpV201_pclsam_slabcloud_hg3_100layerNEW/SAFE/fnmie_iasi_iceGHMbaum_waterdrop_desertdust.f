...
C                 <------------cloud string------------->
       ...
       MIETYP(1)=201
       FNMIEA(1)=
     $ '/asl/data/sarta_database/Data_mie_IASI/iasi_ice_baumGHM_abs.dat'
       FNMIEE(1)=
     $ '/asl/data/sarta_database/Data_mie_IASI/iasi_ice_baumGHM_ext.dat'
       FNMIEG(1)=
     $ '/asl/data/sarta_database/Data_mie_IASI/iasi_ice_baumGHM_asy.dat'
C
