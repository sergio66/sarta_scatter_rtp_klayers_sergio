...
C      mie particles #1: Ammonium Nitrate (0.01 to 10 um)
C                 123456789012345678901234567890123456789
C                 <------------cloud string------------->
       CLDSTR(1)='651=Ammonium Nitrate 80%RH OPAC'
       MIETYP(1)=651
       FNMIEA(1)=
     $ '/asl/data/sarta_database/Data_mie_IASI/AmNit_abs.dat'
       FNMIEE(1)=
     $ '/asl/data/sarta_database/Data_mie_IASI/AmNit_ext.dat'
       FNMIEG(1)=
     $ '/asl/data/sarta_database/Data_mie_IASI/AmNit_asy.dat'
C

C      mie particles #2: Ammonium Sulfate (0.01 to 10 um)
C                 <------------cloud string------------->
       CLDSTR(2)='611=Ammonium Sulfate 80%RH OPAC'
       MIETYP(2)=611
       FNMIEA(2)=
     $ '/asl/data/sarta_database/Data_mie_IASI/AmSul_abs.dat'
       FNMIEE(2)=
     $ '/asl/data/sarta_database/Data_mie_IASI/AmSul_ext.dat'
       FNMIEG(2)=
     $ '/asl/data/sarta_database/Data_mie_IASI/AmSul_asy.dat'
C

C      mie particles #3: biomass burning (0.01 to 10 um)
C                 <------------cloud string------------->
       CLDSTR(3)='501=biom 2010-05-22'
       MIETYP(3)=501
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/biom_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/biom_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_IASI/biom_asy.dat'
C
