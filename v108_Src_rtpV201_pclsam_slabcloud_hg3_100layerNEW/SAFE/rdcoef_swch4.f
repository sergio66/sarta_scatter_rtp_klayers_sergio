...
C       INDHNO, COFHNO, INDN2O, COFN2O, INDCH4, COFCH4,
...
C    REAL arr  COFCH4  CH4 perturbation coefs      various
...
C    INT arr   INDCH4  CH4 pert channel indices    none
...
C 03 Jun 2009 Scott Hannon   Add shortwave CH4
...
C      =================================================================
     ...
     $    INDHNO, COFHNO, INDN2O, COFN2O, INDCH4, COFCH4,
