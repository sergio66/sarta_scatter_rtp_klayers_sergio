...
C                 <------------cloud string------------->
       CLDSTR(3)='301=andesite 2008-06-13'
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/andesite_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/andesite_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_apr08/andesite_asy.dat'
C
