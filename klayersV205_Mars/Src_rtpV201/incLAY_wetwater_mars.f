...
c May 2021    Sergio Machado    MARS MARS MARS
...
C
       PARAMETER(MXIN = 600)
       PARAMETER(NGRID = 10)
       PARAMETER(NGIDS = 6)  !! 1=WV, 2=CO2, 3=N2, 4=O2, 5=CO, 6=NO
       PARAMETER(MXCLD = 3)
...
C      -----------------------------------------------------------------
       CHARACTER*70 DFAFGL  ! Default file for Mars models
C
       PARAMETER(DFAFGL=
c     $ '../Data/glatm.dat')
c     $ '/asl/packages/klayersV205/Data/glatm_9July2010.dat')
c     $ '/asl/packages/klayersV205/Data/glatm.dat')
     $ '/home/sergio/OTHERSTUFF/klayersV205_Mars/Data/glmars.dat')
...
C      -----------------------------------------------------------------
       REAL CO2STD ! standard CO2 PPMV mixing ratio 
       PARAMETER( CO2STD = 950000.0 )
C
C      -----------------------------------------------------------------
