...
C       MIETYP, MIENPS, MIEPS, MIEABS, MIEEXT, MIEASY, VCLOUD )
...
C    CHAR arr  VCLOUD  cloud version strings       none
...
C    05 Jan 2007 Scott Hannon   Fix MIEABS read loop: MIENPS not MXMIEA
...
C      note: unable to do this with include file, hence done with FNMIE
       CALL FNMIE( MIETYP, FNMIEA, FNMIEE, FNMIEG, VCLOUD )
C
