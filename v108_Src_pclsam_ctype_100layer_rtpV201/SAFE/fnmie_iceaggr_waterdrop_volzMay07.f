...
C
C      mie particles #3: volz; correct lognormal, incorrect log(alpha) = (2)
       MIETYP(3)=301
       FNMIEA(3)= 
     $ '/home/sergio/MATLABCODE/JIGOU/DATA/volz_small_0507_log2_abs.dat' 
       FNMIEE(3)= 
     $ '/home/sergio/MATLABCODE/JIGOU/DATA/volz_small_0507_log2_ext.dat' 
       FNMIEG(3)= 
     $ '/home/sergio/MATLABCODE/JIGOU/DATA/volz_small_0507_log2_asy.dat' 
C        40 char <1234567890123456789012345678901234567890>
