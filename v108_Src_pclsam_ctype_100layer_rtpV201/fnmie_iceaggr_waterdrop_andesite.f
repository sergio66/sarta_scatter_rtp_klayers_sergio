...
C
C      mie particles #3: andesite
       MIETYP(3)=301
       FNMIEA(3)=
     $ '/asl/data/sarta_database/Data_mie_m135f/New/andesite_abs.dat'
       FNMIEE(3)=
     $ '/asl/data/sarta_database/Data_mie_m135f/New/andesite_ext.dat'
       FNMIEG(3)=
     $ '/asl/data/sarta_database/Data_mie_m135f/New/andesite_asy.dat'
C        40 char <1234567890123456789012345678901234567890>
       VCLOUD(3)='301 andesite 2004-02-18'
C
       RETURN
       END
