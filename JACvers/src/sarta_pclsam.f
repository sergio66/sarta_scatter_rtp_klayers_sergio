...
C      ---------------------------
     ...
     $    INH3, IOPCI, HEAD, HATT, PATT, LCO2PM, NWANTC, LISTC, RINDCHN)
       ...
       IF (NWANTC .GT. 0) THEN
         print *,'------------------------------------------------------------------------------'
         print *,'after opnrtp, NCHAN = ',NCHAN,'here are the channels'
         print *,'                       I      LSTCHN(I) INDCHN(LSTCHN(I)),RINDCHN(I),FCHAN(I) '
         print *,'------------------------------------------------------------------------------'
         DO I = 1,NCHAN
           print *,'after opnrtp',I,LSTCHN(I),INDCHN(LSTCHN(I)),RINDCHN(I),FCHAN(I)
         END DO
         print *,'------------------------------------------------------------------------------'
       END IF
...
C      print *,NCHN1,NCHN2,NCHN3,NCHN4,NCHN5,NCHN6,NCHN7
