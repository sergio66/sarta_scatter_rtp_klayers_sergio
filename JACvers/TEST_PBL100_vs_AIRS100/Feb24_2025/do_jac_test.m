...
figure(7);
plot(hA.vchan,sum(dA_wgt(1:nA,:),1),'b.-',hA.vchan,sum(dB_wgt(1:nB,:),1))
title('WGT SUM')
...
figure(7);
plot(hA.vchan,sum(dA_TZZ(1:nA,:),1),'b.-',hA.vchan,sum(dB_TZZ(1:nB,:),1),'r',hA.vchan,dA_TZZ(nA+1,:),'c.-',hA.vchan,dB_TZZ(nB+1,:),'m')
title('TZ SUM and ST')
...
figure(7);
plot(hA.vchan,sum(dA_g1(1:nA,:),1),'b.-',hA.vchan,sum(dB_g1(1:nB,:),1),'r')
title('WV SUM')
...
figure(7);
plot(hA.vchan,sum(dA_g2(1:nA,:),1),'b.-',hA.vchan,sum(dB_g2(1:nB,:),1),'r')
title('CO2 SUM')
...
figure(7);
plot(hA.vchan,sum(dA_g3(1:nA,:),1),'b.-',hA.vchan,sum(dB_g3(1:nB,:),1),'r')
title('O3 SUM')
