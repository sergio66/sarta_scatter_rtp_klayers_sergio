...
c        END DO
        ...
        CALL WRTJAC_T(IOUNTZ,BLMULT,IPROF,NLAY,NCHAN,FREQ,RAD,JAC_OUTPUT_UNITS,JAC_ST_C,JAC_TZ_C)
      END IF   
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     $                              CFRA12*JAC_WGT_12(1:NLAY,1:NCHAN)
        CALL WRTJAC_GAS(IOUNWGT,BLMULT,IPROF,NLAY,NCHAN,200,FREQ,RAD,JAC_OUTPUT_UNITS,WAMNT,JAC_WGT_C)
      END IF   
