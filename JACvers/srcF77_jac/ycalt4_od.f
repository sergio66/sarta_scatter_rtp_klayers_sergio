...
!CALL PROTOCOL:
C    YCALT4( INDCHN, NLAY, NCHN4, CLIST4, COEF4,
...
C 03 Feb 1997 Scott Hannon   Re-wrote (from YCALTAU) for FCOW
...
C      =================================================================
       SUBROUTINE YCALT4 ( INDCHN, NLAY, NCHN4, CLIST4,
     $    COEF4, FIXMUL, CONPD4, FPRED4, CPRED4, OPRED4, WPRED4, TRCPRD,
     $    INDCO2, COFCO2, CO2MLT,INDN2O, COFN2O, N2OMLT, TAU, TAUZ, IY, 
