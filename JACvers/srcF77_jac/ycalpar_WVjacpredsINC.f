...
C          -------
           ...
           MJACPRED3(IWHICHJAC,1,L)=MJUNKA
           MJACPRED3(IWHICHJAC,2,L)=MJUNKR
           MJACPRED3(IWHICHJAC,3,L)=MJUNKA*DT
           MJACPRED3(IWHICHJAC,4,L)=MJUNKA*MJUNKA
           MJACPRED3(IWHICHJAC,5,L)=MJUNKA*SECANG(L)
           MJACPRED3(IWHICHJAC,6,L)=MJUNKZ
           MJACPRED3(IWHICHJAC,7,L)=A_M*DT
           MJACPRED3(IWHICHJAC,8,L)=TAZ_M*SECANG(L)
           MJACPRED3(IWHICHJAC,9,L)=SQRT( MJUNKZ )
c STOPPED HERE STOPPED HERE STOPPED HERE 
c STOPPED HERE STOPPED HERE STOPPED HERE 
c STOPPED HERE STOPPED HERE STOPPED HERE 
