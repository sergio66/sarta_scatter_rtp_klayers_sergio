...
%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
frtp = 'TEST_RTP/cloudy_airs_l1c_ecm_sarta_baum_ice.2018.06.29.086_cumsum_-1.op.rtp'; 
[h,ha,p,pa] = rtpread(frtp); 
inds = 1:100:12150; [hx,px] = subset_rtp_allcloudfields(h,p,[],[],inds); 
rtpwrite('TEST_RTP/newdayx_1_100_12150.op.rtp',hx,ha,px,pa);

%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
frtp = 'TEST_RTP/cloudy_airs_l1c_ecm_sarta_baum_ice.2018.06.29.086_cumsum_-1.op.rtp'; %% does not have rcalc!!!
frtp = 'TEST_RTP/cloudy_airs_l1c_ecm_sarta_baum_ice.2018.06.29.086_cumsum_-1.rp.rtp'; %% this does have rcalc
[h,ha,p,pa] = rtpread(frtp); 
...
rtpwrite('TEST_RTP/newdayx_clr.op.rtp',hx,ha,px,pa);
...
rtpwrite('TEST_RTP/newdayx_nocldfields.op.rtp',hx,ha,px,pa);

pxx = px; pxx.gas_1 = pxx.gas_1 *1.1; rtpwrite('TEST_RTP/newdayx_nocldfields_pertWVx1.1.op.rtp',hx,ha,pxx,pa);
pxx = px; pxx.gas_2 = pxx.gas_2 *1.1; rtpwrite('TEST_RTP/newdayx_nocldfields_pertCO2x1.1.op.rtp',hx,ha,pxx,pa);
pxx = px; pxx.gas_3 = pxx.gas_3 *1.1; rtpwrite('TEST_RTP/newdayx_nocldfields_pertO3x1.1.op.rtp',hx,ha,pxx,pa);
pxx = px; pxx.ptemp = pxx.ptemp + 1;  rtpwrite('TEST_RTP/newdayx_nocldfields_pertT_p1.op.rtp',hx,ha,pxx,pa);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%}

frtp = 'TEST_RTP/newdayx_1_100_12150.op.rtp'; iProf = 59;    %% DCC
frtp = 'TEST_RTP/cloudy_airs_l1c_ecm_sarta_baum_ice.2018.06.29.086_cumsum_-1.op.rtp'; iProf = 12150/2+45;  %% satzen = +50  deg
frtp = 'TEST_RTP/newdayx_1_100_12150.op.rtp'; iProf = 113;   %% almost clear
frtp = 'TEST_RTP/newdayx_1_100_12150.op.rtp'; iProf = 1;     %% same as profile 1 from cloudy_airs_l1c_ecm_sarta_baum_ice.2018.06.29.086_cumsum_-1.op.rtp *** HAVE KCARTA JACS ***, at -50 deg

frtp = 'TEST_RTP/newdayx_nocldfields_unityemiss.op.rtp'; iProf = 1; %% satzen =  23  deg   

frtp = 'TEST_RTP/newdayx_clr.op.rtp'; iProf = 1;  %% satzen = 22  deg  *** HAVE KCARTA JACS ***, at 22 deg
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%{
frtp = 'TEST_RTP/cloudy_airs_l1c_ecm_sarta_baum_ice.2018.06.29.086_cumsum_-1.op.rtp'; iProf = 01;     %% *** HAVE KCARTA JACS ***, at -50 deg
kcrads = load('TEST_RTP/individual_prof_convolved_kcarta_airs_1.mat');
kcjacs = load('TEST_RTP/individual_prof_convolved_kcarta_airs_1_jac.mat');

frtp = 'TEST_RTP/cloudy_airs_l1c_ecm_sarta_baum_ice.2018.06.29.086_cumsum_-1.op.rtp'; iProf = 45;     %% *** HAVE KCARTA JACS ***, at 0 deg
kcrads = load('TEST_RTP/individual_prof_convolved_kcarta_airs_45.mat');
kcjacs = load('TEST_RTP/individual_prof_convolved_kcarta_airs_45_jac.mat');
%}
...
if ~exist('porig')
  ...
  sartaer = ['!date; time ../bin/airs_l1c_2834_cloudy_may19_prod_debug fin=' frtp ' fout=jactest.rtp listp=' num2str(iProf)];
  eval(sartaer);
...
kcrads = load('TEST_RTP/individual_prof_convolved_kcarta_airs_CLR_1.mat');
kcjacs = load('TEST_RTP/individual_prof_convolved_kcarta_airs_CLR_1_jac.mat');
