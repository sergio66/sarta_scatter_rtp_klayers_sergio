...
c%%%%%%%%%%%%%%%%%%%%%%%%%
      IF (INTERSECT(1,LISTJ(1:NWANTJ),NWANTJ) .GT. 0) THEN
        ...
        JAC_G1_C(1:NLAY,1:NCHAN)  = JAC_G1_C(1:NLAY,1:NCHAN)  - RTHERM4(1,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN)
        JAC_G1_1(1:NLAY,1:NCHAN)  = JAC_G1_1(1:NLAY,1:NCHAN)  - RTHERM4(2,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN)
        JAC_G1_2(1:NLAY,1:NCHAN)  = JAC_G1_2(1:NLAY,1:NCHAN)  - RTHERM4(3,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN)
        JAC_G1_12(1:NLAY,1:NCHAN) = JAC_G1_12(1:NLAY,1:NCHAN) - RTHERM4(4,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN)
...
!     $             CFRA12*JAC_ST_12(1:NCHAN) * L2S4(4,NLAY,1:NCHAN)
     ...
     $             CFRA12*JAC_ST_12(1:NCHAN) * L2S4above(4,NLAY+1,1:NCHAN)
        ...
        JAC_TZ_C(1:NLAY,1:NCHAN)  = JAC_TZ_C(1:NLAY,1:NCHAN)  - RTHERM4(1,1:NLAY,1:NCHAN) * dTAU_DTZ(1:NLAY,1:NCHAN)
        JAC_TZ_1(1:NLAY,1:NCHAN)  = JAC_TZ_1(1:NLAY,1:NCHAN)  - RTHERM4(2,1:NLAY,1:NCHAN) * dTAU_DTZ(1:NLAY,1:NCHAN)
        JAC_TZ_2(1:NLAY,1:NCHAN)  = JAC_TZ_2(1:NLAY,1:NCHAN)  - RTHERM4(3,1:NLAY,1:NCHAN) * dTAU_DTZ(1:NLAY,1:NCHAN)
        JAC_TZ_12(1:NLAY,1:NCHAN) = JAC_TZ_12(1:NLAY,1:NCHAN) - RTHERM4(4,1:NLAY,1:NCHAN) * dTAU_DTZ(1:NLAY,1:NCHAN)
