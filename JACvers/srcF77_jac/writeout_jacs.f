...
c%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     $             CFRA12*JAC_G2_12(1:NLAY,1:NCHAN) * L2S4(4,1:NLAY,1:NCHAN)
        ...
        CALL WRTJAC_GAS(IOUNG2,IPROF,NLAY,NCHAN,2,FREQ,RAD,JAC_OUTPUT_UNITS,OAMNT,JAC_G2_C)
      END IF   
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     $             CFRA12*JAC_G4_12(1:NLAY,1:NCHAN) * L2S4(4,1:NLAY,1:NCHAN)
        ...
        CALL WRTJAC_GAS(IOUNG4,IPROF,NLAY,NCHAN,4,FREQ,RAD,JAC_OUTPUT_UNITS,OAMNT,JAC_G4_C)
      END IF   
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     $             CFRA12*JAC_G5_12(1:NLAY,1:NCHAN) * L2S4(4,1:NLAY,1:NCHAN)
        ...
        CALL WRTJAC_GAS(IOUNG5,IPROF,NLAY,NCHAN,5,FREQ,RAD,JAC_OUTPUT_UNITS,OAMNT,JAC_G5_C)
      END IF   
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     $             CFRA12*JAC_G6_12(1:NLAY,1:NCHAN) * L2S4(4,1:NLAY,1:NCHAN)
        ...
        CALL WRTJAC_GAS(IOUNG6,IPROF,NLAY,NCHAN,6,FREQ,RAD,JAC_OUTPUT_UNITS,OAMNT,JAC_G6_C)
      END IF   
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     $             CFRA12*JAC_G9_12(1:NLAY,1:NCHAN) * L2S4(4,1:NLAY,1:NCHAN)
        ...
        CALL WRTJAC_GAS(IOUNG9,IPROF,NLAY,NCHAN,9,FREQ,RAD,JAC_OUTPUT_UNITS,OAMNT,JAC_G9_C)
      END IF   
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     $             CFRA12*JAC_G12_12(1:NLAY,1:NCHAN) * L2S4(4,1:NLAY,1:NCHAN)
        ...
        CALL WRTJAC_GAS(IOUNG12,IPROF,NLAY,NCHAN,12,FREQ,RAD,JAC_OUTPUT_UNITS,OAMNT,JAC_G12_C)
      END IF   
