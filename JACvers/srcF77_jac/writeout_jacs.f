...
c%%%%%%%%%%%%%%%%%%%%%%%%%
      IF (INTERSECT(1,LISTJ(1:NWANTJ),NWANTJ) .GT. 0) THEN
        JAC_G1_C(1:NLAY,1:NCHAN)  = RAD4(1,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G1_1(1:NLAY,1:NCHAN)  = RAD4(2,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G1_2(1:NLAY,1:NCHAN)  = RAD4(3,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G1_12(1:NLAY,1:NCHAN) = RAD4(4,1:NLAY,1:NCHAN) * dTAU_DG1(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
      IF (INTERSECT(2,LISTJ(1:NWANTJ),NWANTJ) .GT. 0) THEN
        JAC_G2_C(1:NLAY,1:NCHAN)  = RAD4(1,1:NLAY,1:NCHAN) * dTAU_DG2(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G2_1(1:NLAY,1:NCHAN)  = RAD4(2,1:NLAY,1:NCHAN) * dTAU_DG2(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G2_2(1:NLAY,1:NCHAN)  = RAD4(3,1:NLAY,1:NCHAN) * dTAU_DG2(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G2_12(1:NLAY,1:NCHAN) = RAD4(4,1:NLAY,1:NCHAN) * dTAU_DG2(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
...
c%%%%%%%%%%%%%%%%%%%%%%%%%
      IF (INTERSECT(3,LISTJ(1:NWANTJ),NWANTJ) .GT. 0) THEN
        JAC_G3_C(1:NLAY,1:NCHAN)  = RAD4(1,1:NLAY,1:NCHAN) * dTAU_DG3(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G3_1(1:NLAY,1:NCHAN)  = RAD4(2,1:NLAY,1:NCHAN) * dTAU_DG3(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G3_2(1:NLAY,1:NCHAN)  = RAD4(3,1:NLAY,1:NCHAN) * dTAU_DG3(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
        JAC_G3_12(1:NLAY,1:NCHAN) = RAD4(4,1:NLAY,1:NCHAN) * dTAU_DG3(1:NLAY,1:NCHAN) * RAMU(1:NLAY,1:NCHAN)
