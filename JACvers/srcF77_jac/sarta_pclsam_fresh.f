...
!  cloud jacs
       REAL JACA_G_ASY1(MXCHAN),JACA_NEXTO1(MXCHAN),JACA_NSCAO1(MXCHAN),JACA_FINAL_1(MXCHAN)    !! cld amount jacs
       REAL JACS_G_ASY1(MXCHAN),JACS_NEXTO1(MXCHAN),JACS_NSCAO1(MXCHAN),JACS_FINAL_1(MXCHAN)    !! cld sze jacs
       REAL JACA_G_ASY2(MXCHAN),JACA_NEXTO2(MXCHAN),JACA_NSCAO2(MXCHAN),JACA_FINAL_2(MXCHAN)    !! cld amount jacs
       REAL JACS_G_ASY2(MXCHAN),JACS_NEXTO2(MXCHAN),JACS_NSCAO2(MXCHAN),JACS_FINAL_2(MXCHAN)    !! cld sze jacs
c       REAL JACT_FINAL_1(MXCHAN),JACB_FINAL_1(MXCHAN),JACT_FINAL_2(MXCHAN),JACB_FINAL_2(MXCHAN) !! cld top and bottom jacs
...
c       INTEGER IEFFCLD_TOP1,IEFFCLD_TOP2,IEFFCLD_BOT1,IEFFCLD_BOT2,IFOUND1,IFOUND2
...
C         Skip this profile
       ...
       ENDIF
       IF (DOJAC) THEN
         IF (MOD(IPROF,100) .EQ. 0) THEN
           print *,'doing jacs for profile ',IPROF,' of ',NUMPROF
         END IF
       END IF
