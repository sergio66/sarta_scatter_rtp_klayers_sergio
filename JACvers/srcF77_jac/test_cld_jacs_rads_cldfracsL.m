...
% see ccprep_slab.f
 time ../bin/jac_airs_l1c_2834_cloudy_may19_prod_debug fin=newdayx_1_100_12150.op.rtp               fout=newdayx_1_100_12150.rad.rtp         listp=1  listj=1  listc=1291 >& ugh0_cloudjac_cldfracsL
 time ../bin/jac_airs_l1c_2834_cloudy_may19_prod_debug fin=newdayx_1_100_12150_pert_cprtop1.op.rtp  fout=newdayx_1_100_12150.rad.rtp         listp=1  listj=1  listc=1291 > ugh_cprtop1_cloudjac_cldfracsL
 time ../bin/jac_airs_l1c_2834_cloudy_may19_prod_debug fin=newdayx_1_100_12150_pert_cprbot1.op.rtp  fout=newdayx_1_100_12150.rad.rtp         listp=1  listj=1  listc=1291 > ugh_cprbot1_cloudjac_cldfracsL
%}
...
raw_cldfracsL = load('ugh0_cloudjac_cldfracsL');
pert_cldfracsT1 = load('ugh_cprtop1_cloudjac_cldfracsL');
pert_cldfracsB1 = load('ugh_cprbot1_cloudjac_cldfracsL');
