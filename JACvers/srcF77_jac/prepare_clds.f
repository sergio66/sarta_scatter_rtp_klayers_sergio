...
C           NOTE CLRB1, CLRT1. TCBOT1, TCTOP1,CFRCL1 : depend on CPRTO1,CPRBO1
     ...
     $          CFRCL1, G_ASY1, NEXTO1, NSCAO1,POLYNOM_BACKSCAT1(4),ISCALING1,CTYPE1,
...
C           NOTE CLRB2, CLRT2. TCBOT2, TCTOP2,CFRCL2 : depend on CPRTO2,CPRBO2
     ...
     $          CFRCL2, G_ASY2, NEXTO2, NSCAO2,POLYNOM_BACKSCAT2(4),ISCALING2,CTYPE2,
