...
%% cngwat
 ...
 ii=5; plot(w,jacx.cldjac(:,ii),'b.-',w,d(:,ii));
...
%% cpsize
 ...
 ii=6; plot(w,jacx.cldjac(:,ii),'b.-',w,d(:,ii)); [raw_ODs(2,5) raw_ODs(2,5)+raw_ODs(2,13)*dme20*dQ  pert_ODs2(2,5)]; fprintf(1,'%8.5f %8.6f %8.6f %8.6f \n',junk);      %%  NEXTOD0  NEXT1_ESTMATED     NEXTOD1
%}
