...
c      default to our PCLSAM, unless we have only ONE complex (I/W) cloud
       IPYCODE = -1
       ...
       ELSEIF (CFRAC1 .GT. 0 .AND. CFRAC2 .GT. 0) THEN      
         ...
         ELSEIF (LBLAC1 .AND. (LBLAC2 .EQ. .FALSE.)) THEN
           IPYCODE = -1     !!! top black cloud, bottom complex (I/W/D)
           END IF
         END IF
